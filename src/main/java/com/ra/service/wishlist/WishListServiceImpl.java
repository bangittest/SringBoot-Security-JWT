...
public class WishListServiceImpl implements WishListService{
    ...
    @Override
    public void addWishList(Long userId, WishListRequestDTO wishListRequestDTO) throws UserNotFoundException, WishListException {
        User user = userRepository.findById(userId).orElseThrow(() -> new UserNotFoundException("User not found"));
        Product product = productRepository.findById(wishListRequestDTO.getProductId()).orElseThrow(() -> new ProductNotFoundExceptions("Product not found"));
